...
//         let fulllines = AI.fullLineCount(matrix,game) //计算可以消除的行
//         let avgHeight = 0 //平均高度（去除被消除的）
//         let last = null
//         let delta = 0
...
//             if(last!=null){
//                 delta += Math.abs(height -last);//各列之间高度之差的绝对值之和（去除被消除的）
//             }
//             last = height;
//             avgHeight += height
//         }
...
//         return state.clear * ai.alpha 
//                 + state.avgh * ai.beta
//                 + state.hc * ai.gama
//                 + state.delta * ai.delta
//     }
