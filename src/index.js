...
// import GA from './components/evolution'
...
import './components/evolution.less'
    ...
    render() {
        return (
            <section >
                ...
                <div className="ans_word">{this.state.ans.ans_word}</div>
...
let ga = render(<GA capacity={1000}/>,document.getElementById('Training'))

let game = render(<Game disableMode={true}
